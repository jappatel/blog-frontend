...
const Home = () => {
  ...
  const isLargeScreen = window.innerWidth >= 640; // Example breakpoint, adjust as needed
  ...
  return (
    <div className="z-10 mt-24">
      ...
      <div className="flex justify-center opacity-85 hover:opacity-100">
        <Link to="/allblogs">
          <button className="relative bg-gradient-to-r from-rose-400 to-fuchsia-400 p-2 rounded-2xl mb-5 font-normal">
            Read More Blogs . . .
          </button>
        </Link>
      </div>
